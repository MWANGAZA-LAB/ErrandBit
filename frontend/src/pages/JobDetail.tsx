...
import { FediPayment } from '../components/FediPayment';
        ...
        {job.status === 'completed' && job.invoice && (
          <div className="p-6 bg-gray-50">
            ...
            <FediPayment
              ...
              amount={job.amount}
              runnerInvoice={job.invoice}
              platformFeeInvoice="lnbc5000n1p..." // Mock platform fee invoice (500 sats)
      ...
      {!isInFedi && job.status === 'completed' && (
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div>
              <p className="text-sm font-medium text-blue-800">For Best Experience</p>
              <p className="text-sm text-blue-700 mt-1">
                Open ErrandBit in the Fedi app for instant Lightning payments from your ecash balance.
              </p>
            </div>
          </div>
        </div>
