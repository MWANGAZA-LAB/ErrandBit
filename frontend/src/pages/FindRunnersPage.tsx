                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {runner.skills.slice(0, 3).map(skill => (
                        <span
                          key={skill}
                      ...
                      {runner.skills.length > 3 && (
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                          +{runner.skills.length - 3} more
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                    <div>
                      ...
                      <div className="text-lg font-semibold text-gray-900">{runner.completed_jobs}</div>
                    </div>
                    <div>
                  ...
                  {/* Hourly Rate */}
                  {runner.hourly_rate_usd && (
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <div className="text-sm text-gray-500">Hourly Rate</div>
                      <div className="text-xl font-bold text-indigo-600">
                        ${runner.hourly_rate_usd.toFixed(2)}/hr
                      </div>
                    </div>
                  )}
                </div>
