 ...
 */
export const createRunnerValidation: ValidationChain[] = [
  body('display_name')
    .trim()
 ...
 */
export const updateRunnerValidation: ValidationChain[] = [
  param('id')
    .isInt({ min: 1 })
 ...
 */
export const searchRunnersValidation: ValidationChain[] = [
  query('lat')
    .optional()
    .isFloat({ min: -90, max: 90 })
    .withMessage('Latitude must be between -90 and 90'),
 ...
 */
export const getRunnerValidation: ValidationChain[] = [
  param('id')
    .isInt({ min: 1 })
    .withMessage('Invalid runner ID'),
];
