...
async function verifyExtensions() {
  ...
  try {
    ...
    checks.failed.push(`Extension check failed: ${error.message}`);
...
async function verifyTables() {
  ...
  try {
    ...
    checks.failed.push(`Table check failed: ${error.message}`);
...
async function verifyUsersTable() {
  ...
  try {
    ...
    checks.failed.push(`Users table check failed: ${error.message}`);
...
async function verifyIndexes() {
  ...
  try {
    ...
    checks.warnings.push(`Index check failed: ${error.message}`);
...
async function verifyConstraints() {
  ...
  try {
    ...
    checks.warnings.push(`Constraint check failed: ${error.message}`);
...
async function testConnection() {
  ...
  try {
    ...
    checks.failed.push(`Connection failed: ${error.message}`);
